...
public class MRStage3 {
	...
	public static class NormalizationReduce extends MapReduceBase implements
		...
		public void reduce(Text ikey, Iterator<Text> vlist,
			...
			outputObj.put("countJaccard", sumJaccard);
			outputObj.put("countCosine", sumCosine);
	...
	public static void main(String[] args) throws Exception {
		JobConf conf3 = new JobConf(MRStage3.class);
		conf3.setJobName("Map-Reduce 3 output to MongoDB");
