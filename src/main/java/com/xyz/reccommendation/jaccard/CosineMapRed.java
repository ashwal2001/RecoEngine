 ...
 */
public class CosineMapRed extends Configured implements Tool {
	/**
	...
	public static class NormalizationReduce extends MapReduceBase implements
		...
		public void reduce(Text ikey, Iterator<Text> vlist,
			...
			output.collect(ikey, new BSONWritable(outputObj));
		}
	}
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new CosineMapRed(), args);
		System.exit(res);
	}
	...
	public void pass1() throws Exception {
		// Job configuration
		JobConf conf = new JobConf(CosineMapRed.class);
	...
	public void pass2() throws Exception {
		// Job configuration 2
		JobConf conf2 = new JobConf(CosineMapRed.class);
	...
	public void pass3() throws Exception {
		JobConf conf3 = new JobConf(CosineMapRed.class);
		...
		MongoConfigUtil.setOutputURI(conf3,
				"mongodb://54.251.196.236/products.out_cosine");
